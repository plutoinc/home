...
const RoadMapSection = ({ intl }) => {
  ...
  if (intl.locale === "ko") {
    for (let i = 0; i < 5; i += 1) {
      imageUrl[i] = `https://d2vo77dayzjoat.cloudfront.net/roadMap/ko/step-${i +
        1}.png`;
    }
  } else {
    for (let i = 0; i < 5; i += 1) {
      imageUrl[i] = `https://d2vo77dayzjoat.cloudfront.net/roadMap/en/step-${i +
        1}.png`;
    }
  }
      ...
      <div className={styles.innerContainer}>
        ...
        <div className={styles.stepWrapper}>
          ...
          <div className={styles.imageWrapper}>
            <img
              className={`${styles.stepImage} ${styles.image1}`}
              src={imageUrl[0]}
            />
          </div>
        </div>
        ...
        <div className={styles.stepWrapper}>
          ...
          <div className={styles.imageWrapper}>
            <img
              className={`${styles.stepImage} ${styles.image2}`}
              src={imageUrl[1]}
            />
          </div>
        </div>
        ...
        <div className={styles.stepWrapper}>
          ...
          <div className={styles.imageWrapper}>
            <img
              className={`${styles.stepImage} ${styles.image3}`}
              src={imageUrl[2]}
            />
          </div>
        </div>
        ...
        <div className={styles.stepWrapper}>
          ...
          <div className={styles.imageWrapper}>
            <img
              className={`${styles.stepImage} ${styles.image4}`}
              src={imageUrl[3]}
            />
          </div>
        </div>
        ...
        <div className={styles.stepWrapper}>
          ...
          <div className={styles.imageWrapper}>
            <img
              className={`${styles.stepImage} ${styles.image5}`}
              src={imageUrl[4]}
            />
          </div>
        </div>
