...
const MainSection = ({ email, subscribeEmail, handleEmailChange, shown }) => (
  <section className={`${styles.mainSectionContainer} ${shown ? styles.shown : ""}`}>
    <div className={styles.innerContainer}>
      <div className={styles.title}>Decentralized Scholarly Communication Platform</div>
      <div className={styles.subTitle}>PLUTO makes scholarly communication reasonable and transparent.</div>
      ...
      <div className={styles.followSection}>
        ...
        <a
          onClick={() => trackAndOpenLink("https://medium.com/pluto-network", "MainSection")}
          className={styles.footerIconWrapper}
        >
